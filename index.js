...
// ================= LOAD COMMANDS ARCHITECTURE - RECURSIVE FIX =================
function loadCommands() {
    ...
    for (const filePath of files) {
        try {
            ...
            console.error(`Error mapping dynamic core file ${filePath}:`, e.message);
        }
    }
...
function loadObservers() {
    ...
    for (const filePath of files) {
        try {
            ...
            console.error(`Error mapping observer ${filePath}:`, e.message);
        }
    }
...
// ================= NO-HARDCODED REALTIME SETTINGS SYNC - FIXED SUBSCRIBE ORDER =================
